...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_StartArea.setGeometry(QtCore.QRect(210, 130, 331, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cb_Type.setItemText(0, _translate("MainWindow", "First Type"))
        self.cb_Type.setItemText(1, _translate("MainWindow", "Second Type"))
        self.lbl_Locked.setText(_translate("MainWindow", "Locked"))
        self.lbl_Environment.setText(_translate("MainWindow", "Environment:"))
        self.cb_Environment.setItemText(0, _translate("MainWindow", "First Env"))
        self.cb_Environment.setItemText(1, _translate("MainWindow", "Second Env"))
